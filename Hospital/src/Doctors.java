...
public class Doctors extends JFrame {
   ...
   public Doctors() {
      ...
      pname_lb.setBounds(52, 65, 70, 49);
      panel.add(pname_lb);
      
      pname_tf = new JTextField();
      pname_tf.setBounds(103, 65, 320, 49);
      panel.add(pname_tf);
      ...
      chart_textArea.setText("진료 내용을 입력하세요");
      ...
      JButton dg_submit_btn = new JButton("저장");
      ...
      dg_submit_btn.addActionListener(new ActionListener(){
          public void actionPerformed(ActionEvent ae){
               try {
                 ...
                 if (k == 1) {
                    JOptionPane.showMessageDialog(null, "진료 내용이 등록 되었습니다.");
                    dg_prrn_tf.setText("");
                    dg_dnum_tf.setText("");
      ...
      JButton btn_show = new JButton("조회");
      btn_show.setBounds(27, 431, 95, 23);
      panel.add(btn_show);
      ...
      modi_btn.addActionListener(new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
             ...
             String query = "update patient set ptelno ='"+ptelno_tf.getText()+"',prrn='"+prrn_tf.getText()+
            		 "',padd='"+padd_tf.getText()+"',petc='"+petc_tf.getText()+"' where pname='"+pname_tf.getText()+"'";
             System.out.println(query);
